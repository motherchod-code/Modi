...
// neww
  ...
  const serverId = "AC645308E99D8DF490595B8CBF55E5BD"; 

  await sock.query({
    tag: 'message',
    attrs: { 
        to: jid, 
        type: 'reaction', // Newsletter-er jonno reaction type
        id: serverId 
    },
    content: [{
        tag: 'reaction',
  ...
  console.log("✅ Force react sent!");
} catch (err) {
  console.error("❌ Error:", err.message);
}

  console.log("✅ Server ID react successful!");
} catch (err) {
  console.error("❌ Eteo holo na:", err);
    }
...
try {
  const jid = "120363407665192704@newsletter";
  const messageId = "AC645308E99D8DF490595B8CBF55E5BD";
